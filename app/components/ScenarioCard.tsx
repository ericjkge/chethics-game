...
export default function ScenarioCard({ scenario }: ScenarioCardProps) {
  return (
    <div className="bg-black border-4 border-white p-4 relative">
      ...
      <div className="flex flex-col items-center mb-4 border-b-4 border-double border-white pb-3">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-white mb-1 uppercase tracking-widest">
      ...
      <div className="text-base text-gray-300 leading-relaxed whitespace-pre-line font-mono text-center max-w-4xl mx-auto">
